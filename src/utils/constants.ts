...
export const APP_NAME = 'Soberi.ai';
export const APP_VERSION = '1.0.0';

// API Configuration
export const API_CONFIG = {
  OPENAI_API_KEY: import.meta.env.VITE_OPENAI_API_KEY || 'adkbkfbkd',
  BACKEND_URL: import.meta.env.VITE_BACKEND_URL || 'https://soberi-backend-service-280233666207.europe-west1.run.app',
  BACKEND_API_KEY: import.meta.env.VITE_BACKEND_API_KEY || 'sk-proj-sssssdffsdfwerwrwerdhhjmnvdfd2133443',
};
