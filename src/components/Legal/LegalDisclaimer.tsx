  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
        <h4 className="text-sm font-medium text-blue-800">Medical Disclaimer</h4>
        <p className="text-xs text-blue-700 mt-1">
          MyBoo.ai is an informational and self-help tool only. The content and conversations provided by the service do not constitute medical advice, diagnosis, or treatment and do not create a clinician–patient relationship.
        </p>
      </div>
      ...
      <div className="bg-red-50 border border-red-100 rounded-lg p-4">
        <h4 className="text-sm font-medium text-red-800">Emergency Disclaimer</h4>
        <p className="text-xs text-red-700 mt-1">
          If you believe you may harm yourself or others, or are having a medical emergency, call your local emergency number (911) immediately. MyBoo.ai cannot contact emergency services on your behalf.
        </p>
      </div>
